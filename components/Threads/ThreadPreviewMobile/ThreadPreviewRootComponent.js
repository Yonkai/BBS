...
const ThreadPreviewRootComponent = (props) => (
    <>
      <div>
        <ReplyRootComponent indivdualThreadData = {props.indivdualThreadData} threadID={props.indivdualThreadData.id} originalThreadReplyData={props.originalThreadReplyData}/>
      </div>
        <style jsx>{`
          p {
            font-family: "Roboto";
